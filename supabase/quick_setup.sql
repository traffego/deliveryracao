-- =====================================================
-- SETUP COMPLETO AUTOMÁTICO - Loja Pet Ração Centro
...
-- 4. Inserir Produtos de Exemplo (usando subquery para pegar category_id automaticamente)
...
-- ✅ PRONTO! 
-- Acesse: https://doglivery.vercel.app/loja/pet-racao-centro
